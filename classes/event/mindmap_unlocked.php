...
/**
 * mod_advmindmap mindmap unlocked event.
 *
...
/**
 * mod_advmindmap mindmap unlocked event class.
 *
 * @package    mod_advmindmap
 * @copyright  2014 Andy Chan
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mindmap_unlocked extends \core\event\base {
    ...
    public function get_description() {
        return "The user {$this->userid} has unlocked the mindmap {$this->objectid}.";
    }
    ...
    public static function get_name() {
        return get_string('event_mindmap_unlocked', 'mod_advmindmap');
    }
